...
class Ui_role(object):
    def setupUi(self, role):
        ...
        self.size.setGeometry(QtCore.QRect(160, 80, 81, 22))
        ...
        self.name.setGeometry(QtCore.QRect(160, 20, 171, 22))
        ...
        self.level.setGeometry(QtCore.QRect(160, 50, 41, 22))
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 110, 101, 21))
        ...
        self.strength.setGeometry(QtCore.QRect(160, 110, 71, 22))
        ...
        self.type.setGeometry(QtCore.QRect(160, 140, 111, 22))
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 170, 101, 21))
        ...
        self.comboBox_5.setGeometry(QtCore.QRect(160, 170, 81, 22))
        ...
        self.label_7.setGeometry(QtCore.QRect(30, 200, 101, 21))
        ...
        self.favored_defense.setGeometry(QtCore.QRect(160, 200, 41, 41))
        ...
        self.initiative_modifier.setGeometry(QtCore.QRect(160, 250, 191, 22))
        ...
        self.label_9.setGeometry(QtCore.QRect(30, 280, 101, 21))
        ...
        self.template_2 = QtWidgets.QComboBox(parent=self.centralwidget)
        self.template_2.setGeometry(QtCore.QRect(160, 280, 91, 22))
        ...
        self.label_10.setGeometry(QtCore.QRect(30, 310, 101, 16))
        ...
        self.label_11.setGeometry(QtCore.QRect(160, 310, 101, 16))
        ...
        self.immunities.setGeometry(QtCore.QRect(50, 330, 81, 191))
        ...
        self.vulnerabilities.setGeometry(QtCore.QRect(160, 330, 81, 191))
        ...
        self.displayOutput.setGeometry(QtCore.QRect(370, 20, 341, 501))
        self.displayOutput.setObjectName("displayOutput")
        self.generateButton = QtWidgets.QPushButton(parent=self.centralwidget)
        self.generateButton.setGeometry(QtCore.QRect(630, 530, 75, 24))
        self.generateButton.setObjectName("generateButton")
        self.resetButton = QtWidgets.QPushButton(parent=self.centralwidget)
        self.resetButton.setGeometry(QtCore.QRect(540, 530, 75, 24))
        self.resetButton.setObjectName("resetButton")
        self.label_12 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(30, 530, 101, 21))
        ...
        self.label_13.setGeometry(QtCore.QRect(30, 580, 101, 21))
        ...
        self.attack_name = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.attack_name.setGeometry(QtCore.QRect(40, 600, 91, 21))
        self.attack_name.setObjectName("attack_name")
        self.attack_defense = QtWidgets.QComboBox(parent=self.centralwidget)
        self.attack_defense.setGeometry(QtCore.QRect(160, 600, 41, 22))
        self.attack_defense.setObjectName("attack_defense")
        self.attack_defense.addItem("")
        self.attack_defense.addItem("")
        self.attack_defense.addItem("")
        self.attack_label = QtWidgets.QLabel(parent=self.centralwidget)
        self.attack_label.setGeometry(QtCore.QRect(130, 600, 21, 21))
        self.attack_label.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.attack_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.attack_label.setObjectName("attack_label")
        self.attack_type = QtWidgets.QComboBox(parent=self.centralwidget)
        self.attack_type.setGeometry(QtCore.QRect(210, 600, 101, 22))
        self.attack_type.setCurrentText("")
        self.attack_type.setObjectName("attack_type")
        self.attack_type.addItem("")
        self.attack_type.setItemText(0, "")
        self.attack_type.addItem("")
        self.attack_type.addItem("")
        self.attack_type.addItem("")
        self.attack_type.addItem("")
        ...
        self.template_2.setCurrentIndex(0)
        self.attack_defense.setCurrentIndex(0)
    ...
    def retranslateUi(self, role):
        ...
        self.size.setCurrentText(_translate("role", "Medium"))
        self.size.setItemText(0, _translate("role", "Tiny"))
        self.size.setItemText(1, _translate("role", "Small"))
        self.size.setItemText(2, _translate("role", "Medium"))
        self.size.setItemText(3, _translate("role", "Large"))
        self.size.setItemText(4, _translate("role", "Huge"))
        ...
        self.comboBox_5.setCurrentText(_translate("role", "Mook"))
        self.comboBox_5.setItemText(0, _translate("role", "Mook"))
        self.comboBox_5.setItemText(1, _translate("role", "Archer"))
        self.comboBox_5.setItemText(2, _translate("role", "Blocker"))
        self.comboBox_5.setItemText(3, _translate("role", "Caster"))
        self.comboBox_5.setItemText(4, _translate("role", "Leader"))
        self.comboBox_5.setItemText(5, _translate("role", "Spoiler"))
        self.comboBox_5.setItemText(6, _translate("role", "Troop"))
        self.comboBox_5.setItemText(7, _translate("role", "Wrecker"))
        ...
        self.template_2.setCurrentText(_translate("role", "None"))
        self.template_2.setItemText(0, _translate("role", "None"))
        self.template_2.setItemText(1, _translate("role", "Scrapper"))
        self.template_2.setItemText(2, _translate("role", "Offensive"))
        self.template_2.setItemText(3, _translate("role", "Oaf"))
        self.template_2.setItemText(4, _translate("role", "Defensive"))
        self.template_2.setItemText(5, _translate("role", "Lunk"))
        self.template_2.setItemText(6, _translate("role", "Brittle"))
        self.template_2.setItemText(7, _translate("role", "Leader"))
        ...
        self.attack_name.setText(_translate("role", "Attack Name"))
        self.attack_defense.setCurrentText(_translate("role", "AC"))
        self.attack_defense.setItemText(0, _translate("role", "AC"))
        self.attack_defense.setItemText(1, _translate("role", "PD"))
        self.attack_defense.setItemText(2, _translate("role", "MD"))
        self.attack_label.setText(_translate("role", "vs."))
        self.attack_type.setItemText(1, _translate("role", "Acid"))
        self.attack_type.setItemText(2, _translate("role", "Cold"))
        self.attack_type.setItemText(3, _translate("role", "Fire"))
        self.attack_type.setItemText(4, _translate("role", "Force"))
        self.attack_type.setItemText(5, _translate("role", "Lightning"))
        self.attack_type.setItemText(6, _translate("role", "Necrotic"))
        self.attack_type.setItemText(7, _translate("role", "Poison"))
        self.attack_type.setItemText(8, _translate("role", "Psychic"))
        self.attack_type.setItemText(9, _translate("role", "Radiant"))
        self.attack_type.setItemText(10, _translate("role", "Thunder"))
